...
$quotes = array(
    ...
    "We require all memebers to know how to tango, mamba, and know various forms of breakdance!",
    "Every card in our deck is a trap card",
    "I shot Yahoo, but I did not shoot...",
    ...
    "Legally, we cannot continue to pretend that you don't exist",
    "In colour!",
    "In hypno-vision",
    "As seen on TV",
    ...
    "Robbing the General Public by Proxy",
    ...
    "Do not inhale",
    "Now serving colored induced headaches for a limited time only!",
    ...
    "At the mercy of our Illustrious Web Developer",
    ...
    "Please enter your beautiful people's ID number for the real website",
    ...
    "10,000 Years from now they'll think back on our website and go 'Yep, thats when it started'",
    "If we are rubber and you are glue then perhaps what we say about us bounces back to you?",
    "If sticks and stones can break your bones and names will never hurt you, We have pipes and knives to cut you",
    "Snowblowin",
    ...
    "Our theme song's genre is definatley trap music",
    ...
    "The flames in your TV are not part of the website",
    "Now available without a prescription",
    "Too hot for radio",
    "A by-product of the internet",
    "Tell Your Parents It's Educational!",
    "Two scoops of pixels in every page!",
    ...
    "Provides a full day's supply of Vitamin Q",
    "Warning: Do Not Show To Horses",
    "Tell me how we havin fun",
    "Turn it up, so you can hear the screaming.",
	"I have a friend in japan",
    "You can change the outcome of this website with the power of your mind.",
    ...
    "I'm not afraid of big earthquakes As long as the ground doesn't shake and I'm not scared of rattlesnakes If they don't bite but feed me cake",
    ...
    "We brought chairs just in case you can't stand it anymore...",
    "Violets are blue. Roses are red. We're coming aboard. Prepare to eat lead.",
    "Quick, jump into the Computer while they're not looking!",
    "This website uses cookies to store data on your computer, I'm okay with this",
    "... And the hidden bonus Track!",
    "Ask your doctor if Almost-There is right for you",
    "By the time you read this you've already read it",
    "It's you and me against the world. We attack at dawn.",
    "I'm gonna open up my own personal can of Powerpuff on you",
    "Kenny and Orca sittin in a tree",
    "When you browse other sites, we start talking about you behind your back.",
    "It's not enough to succeed, others must fail.",
    "Shouldn't you be playing outside or something?",
    "What, you again? Hey it's your life",
    "This is the end. Smash your computer",
    "It's like stupid in stereo.",
    "Now hatred is the highest pleasure. Men love and haste, but detest at leasure.",
...
$nsfwQuotes = array( 
    ...
    "gyes i qm so ilek on djqks rint niw",
    ...
    "Meanwhile in Africa",
    "You're down to earth, just not deep enough",
