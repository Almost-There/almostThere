...
/*
	function youtubePlayer() {
		...
		echo "	<iframe src='//www.youtube.com/embed/";
				...
				shuffle($yts);
				// There is this part of me that still doesnt believe random is random so just to double check we shuffle too.
...
class square_steamgroup extends square {
	var $squareName="Steam Group";
	var $squareId="steamgroup";
	var $squareIcon="icon-steam2";
	var $squareSize="sq";
//	var $squareContent="hello";
};
